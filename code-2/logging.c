...
#ifdef DEBUG_SAVE_USER_STACK
    pr_info("%s: [SAVE USER STACK] [%d] Range Stack User to copy [%px , %px]\n",
            MOD_NAME,
            current->pid,
            (void *)start_address,
...
#ifdef DEBUG_REGISTRAZIONE_EVENTO
    pr_info("%s: [Event registration] [%d] %s", MOD_NAME, current->pid, event_ret_suc);
#endif
...
#ifdef DEBUG_REGISTRAZIONE_EVENTO
                pr_info("%s: [Event registration] [%d] %s", MOD_NAME, current->pid, event_ret);
#endif
...
#ifdef DEBUG_REGISTRAZIONE_EVENTO
    pr_info("%s: [Event registration] [%d] %s", MOD_NAME, current->pid, event_call);
#endif
...
#ifdef DEBUG_REGISTRAZIONE_EVENTO
    pr_info("%s: [Event registration] [%d] %s", MOD_NAME, current->pid, event_no_call);
#endif
